...
<div class="container1 my-4">
  <div class="container-fluid1 p-3 m-0 mt-4 row"> <h2 style="color: red;  font-size: 35px; font-family:'Gill Sans',
   ...
   </span> COLECCIONES DE VINOS <span style="flex: 1;  margin: 30px;  border-top: 2px solid rgb(221, 20, 20);"></span> </h2>
</div>
      ...
      <div class="col d-flex justify-content-center">
        <div class="card h-100">
          ...
          <div class="card-body d-flex flex-column align-items-center">
            ...
            <a href="carrito.html" class="btn btn-darger">AÑADIR AL CARRITO</a>
          </div>
        </div>
      </div>
      <div class="col d-flex justify-content-center">
